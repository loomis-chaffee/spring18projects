...
var _user$project$SavingState2$binarydivsblack = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
						...
						_1: {
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'justify-content', _1: 'end'},
										_1: {
											ctor: '::',
...
var _user$project$SavingState2$binarydivswhite = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'padding', _1: '5px'},
		_1: {
...
var _user$project$SavingState2$divsformat = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'padding', _1: '20px'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'background-color', _1: '#ffa07a'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'display', _1: 'flex'},
				_1: {
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'width', _1: '1100px'},
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$SavingState2$contents = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'padding', _1: '20px'},
		_1: {
								...
								_1: {
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'width', _1: '1200px'},
												_1: {ctor: '[]'}
											}
										}
									}
...
var _user$project$SavingState2$container = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'padding', _1: '20px'},
		_1: {
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'background-color', _1: '#faebd7'},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'display', _1: 'flex'},
								_1: {
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'width', _1: '1300px'},
												_1: {ctor: '[]'}
											}
										}
									}
...
var _user$project$SavingState2$numToBinary = function (x) {
	var _p0 = x;
	if (_p0 === 0) {
		return '';
	} else {
		var _p1 = _p0;
		return _elm_lang$core$Native_Utils.eq(
			A2(_elm_lang$core$Basics_ops['%'], _p1, 2),
			1) ? A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$SavingState2$numToBinary((_p1 / 2) | 0),
			'1') : A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$SavingState2$numToBinary((_p1 / 2) | 0),
			'0');
...
var _user$project$SavingState2$normalhour = function (t) {
	return (_elm_lang$core$Native_Utils.cmp(t, 12) > 0) ? _elm_lang$core$Basics$toString(t - 12) : _elm_lang$core$Basics$toString(t);
};
var _user$project$SavingState2$specialcases = function (t) {
	return (_elm_lang$core$Native_Utils.cmp(t, 10) < 0) ? A2(
		_elm_lang$core$Basics_ops['++'],
		'0',
		_elm_lang$core$Basics$toString(t)) : _elm_lang$core$Basics$toString(t);
};
var _user$project$SavingState2$initFunction = function (maybeString) {
	var _p2 = maybeString;
	if (_p2.ctor === 'Just') {
		var _p3 = _p2._0;
		return {
...
var _user$project$SavingState2$update = F2(
		...
		switch (_p4.ctor) {
			case 'Tick':
				...
				return _elm_lang$core$Native_Utils.update(
					state,
					{
						now: _elm_lang$core$Date$fromTime(_p5),
						secondsNow: _elm_lang$core$Basics$toFloat(
							(_elm_lang$core$Basics$round(_p5) / 1000) | 0)
					});
			case 'ChangeYear':
				return _elm_lang$core$Native_Utils.update(
					state,
...
var _user$project$SavingState2$charToDiv = function (c) {
	var _p6 = c;
	if (_p6.valueOf() === '1') {
		return A2(
			...
			{
				ctor: '::',
				_0: _user$project$SavingState2$binarydivsblack,
				_1: {ctor: '[]'}
			},
			{ctor: '[]'});
	} else {
		return A2(
			...
			{
				ctor: '::',
				_0: _user$project$SavingState2$binarydivswhite,
				_1: {ctor: '[]'}
			},
			{ctor: '[]'});
	}
};
var _user$project$SavingState2$appToStore = function (state) {
	return {year: state.year, month: state.month, day: state.day, hour: state.hour, minute: state.minute, second: state.second};
};
var _user$project$SavingState2$storeState = _elm_lang$core$Native_Platform.outgoingPort(
	'storeState',
	function (v) {
		return {year: v.year, month: v.month, day: v.day, hour: v.hour, minute: v.minute, second: v.second};
	});
var _user$project$SavingState2$updateAndSave = F2(
	function (event, state) {
		var newState = A2(_user$project$SavingState2$update, event, state);
		return {
			ctor: '_Tuple2',
			_0: newState,
			_1: _user$project$SavingState2$storeState(
				_user$project$SavingState2$appToStore(newState))
		};
	});
var _user$project$SavingState2$AppState = F8(
	function (a, b, c, d, e, f, g, h) {
		return {secondsNow: a, now: b, year: c, month: d, day: e, hour: f, minute: g, second: h};
	});
var _user$project$SavingState2$StoreState = F6(
	function (a, b, c, d, e, f) {
		return {year: a, month: b, day: c, hour: d, minute: e, second: f};
	});
var _user$project$SavingState2$ChangeSecond = function (a) {
	return {ctor: 'ChangeSecond', _0: a};
};
var _user$project$SavingState2$ChangeMinute = function (a) {
	return {ctor: 'ChangeMinute', _0: a};
};
var _user$project$SavingState2$ChangeHour = function (a) {
	return {ctor: 'ChangeHour', _0: a};
};
var _user$project$SavingState2$ChangeDay = function (a) {
	return {ctor: 'ChangeDay', _0: a};
};
var _user$project$SavingState2$ChangeMonth = function (a) {
	return {ctor: 'ChangeMonth', _0: a};
};
var _user$project$SavingState2$ChangeYear = function (a) {
	return {ctor: 'ChangeYear', _0: a};
};
var _user$project$SavingState2$view = function (state) {
	var s = (_elm_lang$core$Basics$round(
		_Bogdanp$elm_time$Time_DateTime$toTimestamp(
			_Bogdanp$elm_time$Time_DateTime$dateTime(
				{year: state.year, month: state.month, day: state.day, hour: state.hour, minute: state.minute, second: state.second, millisecond: 0}))) / 1000) | 0;
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _user$project$SavingState2$container,
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Binary Clock'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: _elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(
								(_elm_lang$core$Basics$round(state.secondsNow) - s) - 14400)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{ctor: '[]'},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								_user$project$SavingState2$numToBinary(
									(_elm_lang$core$Basics$round(state.secondsNow) - s) - 14400)),
							_1: {ctor: '[]'}
						}),
					_1: {
							...
							A2(
								...
								A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										_elm_lang$core$Basics$toString(
											_elm_lang$core$Date$year(state.now)),
										A2(
											_elm_lang$core$Basics_ops['++'],
											' ',
											A2(
												_elm_lang$core$Basics_ops['++'],
												_elm_lang$core$Basics$toString(
													_elm_lang$core$Date$month(state.now)),
												A2(
													_elm_lang$core$Basics_ops['++'],
													'.',
													A2(
														_elm_lang$core$Basics_ops['++'],
														_elm_lang$core$Basics$toString(
															_elm_lang$core$Date$day(state.now)),
														A2(
															_elm_lang$core$Basics_ops['++'],
															' ',
															A2(
																_elm_lang$core$Basics_ops['++'],
																_elm_lang$core$Basics$toString(
																	_elm_lang$core$Date$dayOfWeek(state.now)),
																A2(
																	_elm_lang$core$Basics_ops['++'],
																	' ',
																	A2(
																		_elm_lang$core$Basics_ops['++'],
																		_user$project$SavingState2$normalhour(
																			_elm_lang$core$Date$hour(state.now)),
																		A2(
																			_elm_lang$core$Basics_ops['++'],
																			':',
																			A2(
																				_elm_lang$core$Basics_ops['++'],
																				_user$project$SavingState2$specialcases(
																					_elm_lang$core$Date$minute(state.now)),
																				A2(
																					_elm_lang$core$Basics_ops['++'],
																					':',
																					_user$project$SavingState2$specialcases(
																						_elm_lang$core$Date$second(state.now))))))))))))))))),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$p,
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Birth time (please enter integers): '),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
													...
													_0: A2(
														_elm_lang$html$Html$input,
														{
															...
															_0: _elm_lang$html$Html_Events$onInput(
																function (s) {
																	return _user$project$SavingState2$ChangeYear(
																		A2(
															...
															_1: {
																...
																_0: _elm_lang$html$Html_Attributes$value(
																	_elm_lang$core$Basics$toString(state.year)),
																_1: {ctor: '[]'}
															}
														},
														{ctor: '[]'}),
													...
													_1: {
														...
														_0: A2(
															_elm_lang$html$Html$input,
															{
																...
																_0: _elm_lang$html$Html_Events$onInput(
																	function (s) {
																		return _user$project$SavingState2$ChangeMonth(
																			A2(
																				_elm_lang$core$Result$withDefault,
																				0,
																				_elm_lang$core$String$toInt(s)));
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$value(
																		_elm_lang$core$Basics$toString(state.month)),
																	_1: {ctor: '[]'}
																}
															},
															{ctor: '[]'}),
														...
														_1: {
															...
															_0: A2(
																_elm_lang$html$Html$input,
																{
																	...
																	_0: _elm_lang$html$Html_Events$onInput(
																		function (s) {
																			return _user$project$SavingState2$ChangeDay(
																				A2(
																					_elm_lang$core$Result$withDefault,
																					0,
																					_elm_lang$core$String$toInt(s)));
																	...
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$value(
																			_elm_lang$core$Basics$toString(state.day)),
																		_1: {ctor: '[]'}
																	}
																},
																{ctor: '[]'}),
															...
															_1: {
																...
																_0: A2(
																	_elm_lang$html$Html$input,
																	{
																		...
																		_0: _elm_lang$html$Html_Events$onInput(
																			function (s) {
																				return _user$project$SavingState2$ChangeHour(
																					A2(
																						_elm_lang$core$Result$withDefault,
																						0,
																						_elm_lang$core$String$toInt(s)));
																		...
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$value(
																				_elm_lang$core$Basics$toString(state.hour)),
																			_1: {ctor: '[]'}
																		}
																	},
																	{ctor: '[]'}),
																...
																_1: {
																	...
																	_0: A2(
																		_elm_lang$html$Html$input,
																		{
																			...
																			_0: _elm_lang$html$Html_Events$onInput(
																				function (s) {
																					return _user$project$SavingState2$ChangeMinute(
																						A2(
																							_elm_lang$core$Result$withDefault,
																							0,
																							_elm_lang$core$String$toInt(s)));
																			...
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$value(
																					_elm_lang$core$Basics$toString(state.minute)),
																				_1: {ctor: '[]'}
																			}
																		},
																		{ctor: '[]'}),
																	...
																	_1: {
																		...
																		_0: A2(
																			_elm_lang$html$Html$input,
																			{
																				...
																				_0: _elm_lang$html$Html_Events$onInput(
																					function (s) {
																						return _user$project$SavingState2$ChangeSecond(
																							A2(
																								_elm_lang$core$Result$withDefault,
																								0,
																								_elm_lang$core$String$toInt(s)));
																				...
																				_1: {
																					ctor: '::',
																					_0: _elm_lang$html$Html_Attributes$value(
																						_elm_lang$core$Basics$toString(state.second)),
																					_1: {ctor: '[]'}
																				}
																			},
																			{ctor: '[]'}),
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _user$project$SavingState2$contents,
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$h2,
											{
												...
												_0: _elm_lang$html$Html_Attributes$style(
													{
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 'color', _1: 'brown'},
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Binary Representation of the Number of Seconds You\'ve Been Born'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _user$project$SavingState2$divsformat,
													_1: {ctor: '[]'}
												},
												A2(
													_elm_lang$core$List$map,
													_user$project$SavingState2$charToDiv,
...
var _user$project$SavingState2$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$SavingState2$subscriptions = function (state) {
	return A2(
		_elm_lang$core$Time$every,
		_elm_lang$core$Time$second,
		function (t) {
			return _user$project$SavingState2$Tick(t);
		});
};
var _user$project$SavingState2$main = _elm_lang$html$Html$programWithFlags(
	{
		init: function (s) {
			var newState = _user$project$SavingState2$initFunction(s);
			return {
				ctor: '_Tuple2',
				_0: newState,
				_1: _user$project$SavingState2$storeState(
		...
		update: _user$project$SavingState2$updateAndSave,
		subscriptions: _user$project$SavingState2$subscriptions,
		view: _user$project$SavingState2$view
	})(
											...
											return A2(
												...
												function (month) {
													return A2(
														...
														A2(_elm_lang$core$Json_Decode$field, 'second', _elm_lang$core$Json_Decode$int));
												},
...
var Elm = {};
Elm['SavingState2'] = Elm['SavingState2'] || {};
if (typeof _user$project$SavingState2$main !== 'undefined') {
    _user$project$SavingState2$main(Elm['SavingState2'], 'SavingState2', undefined);
}
